...
<table width="100%" height="70%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <%--</td>--%>
        <td align="center" bgcolor="#589DFF">
            <font size="7">商&nbsp;&nbsp;&nbsp;&nbsp;城&nbsp;&nbsp;&nbsp;&nbsp;管&nbsp;&nbsp;&nbsp;&nbsp;理&nbsp;&nbsp;&nbsp;&nbsp;系&nbsp;&nbsp;&nbsp;&nbsp;统</font>
        </td>
        <%--<td width="88%" background="/images/top_100.jpg">--%>
        <%--</td>--%>
    </tr>
</table>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="155" valign="bottom"
                                    background="${pageContext.request.contextPath}/images/mis_05b.jpg">
                                    用户名：
                                    <font color="blue"><c:out value="${sessionScope.exitAdminUser.username}"/></font>
                                </td>
