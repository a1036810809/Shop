...
<body>
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminCategory/update"
      method="post">
    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff" colspan="3">
                <input type="text" name="cname" value="<c:out value="${model.cname}"/>"
