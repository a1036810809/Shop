...
<body>
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminCategorySecond/save"
      method="post">
    &nbsp;
            ...
            <td class="ta_01" bgColor="#ffffff">
                <select name="category.cid">
                    <c:forEach var="c" items="${cList}">
                        <option value="<c:out value="${c.cid}" />"><c:out value="${c.cname}"/></option>
                    </c:forEach>
                </select>
            </td>
        </tr>
