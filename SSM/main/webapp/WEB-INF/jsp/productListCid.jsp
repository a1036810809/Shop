            ...
            <div class="pagination">
                ...
                <c:if test="${cid != null}">
                    <c:if test="${pageBean.page != 1}">
                        <a href="<c:out value="${basePath}"/>/product/findByCid?cid=<c:out value="${cid}" />&page=1" class="firstPage">&nbsp;</a>
                        <a href="<c:out value="${basePath}"/>/product/findByCid?cid=<c:out value="${cid}" />&page=<c:out value="${pageBean.page-1}" />"
                    ...
                    <c:if test="${pageBean.page != pageBean.totalPage}">
                        <a class="nextPage"
                           href="<c:out value="${basePath}"/>/product/findByCid?cid=<c:out value="${cid}" />&page=<c:out value="${pageBean.page + 1}"/>">&nbsp;</a>
                        <a class="lastPage"
                           href="<c:out value="${basePath}"/>/product/findByCid?cid=<c:out value="${cid}" />&page=<c:out value="${pageBean.totalPage}"/>">&nbsp;</a>
                    </c:if>
                </c:if>
            </div>
        </form>
