...
<head>
    ...
    <script>
        ...
        function checkUsername() {
            ...
            //3.打开连接
            xhr.open("GET", "${basePath}/user/findByName?username=" + username + "&time=" + new Date().getTime(), true);
            //4.发送
            xhr.send(null);
        }
    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" action="<c:out value="${basePath}"/>/user/regist" method="post" novalidate="novalidate"
                      onsubmit="checkForm()">
                    <table>
                        <tbody>
                        <tr>
