...
public class ActionProductController {
	...
	public SverResponse<List<ActionProduct>> findHotProducts(Integer num){
		return aProductService.findHotProductsP(num);
	}
	/**
	 * 查找楼层商品
	 * @return
	...
	public SverResponse<ActionProductFloorVo> findFloorProducts(){
		return aProductService.findFloorProductsP();
	}
	/**
	 * 根据商品编号，获取商品详情
	 * @param productId
	...
	public SverResponse<ActionProduct> getProductDetail(Integer productId){
		return aProductService.findProductDetailForPortalP(productId);
	}
	/**
	 * 根据条件查询商品
	 * @param productTypeId
	...
	public SverResponse<PageBean<ActionProductListVo>> searchProducts(Integer productTypeId,
		...
		return aProductService.findProductsForProtalP(productTypeId,partsId,name,pageNum,pageSize);
	}
}
