...
<head>
    ...
    <script>
        ...
        function checkUsername() {
            ...
            //3.打开连接
            xhr.open("GET", "user_findByName.action?username=" + username + "&time=" + new Date().getTime(), true);
            //4.发送
            xhr.send(null);
        }
    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" action="user_regist.action" method="post" novalidate="novalidate"
                      onsubmit="checkForm()">
                    <table>
                        <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <span id="span1"><s:fielderror fieldName="username"/></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
										...
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha"
                                                   maxlength="4"><img id="checkImg" class="captchaImage"
                                                                      src="checkImg.action" onclick="change()"
                    ...
                    <div class="login">
                        ...
                        <dl>
                            ...
                            <dd>
                                立即登录即可体验在线购物！
                                <a href="./user_loginPage.action">立即登录</a>
                            </dd>
                        </dl>
                    </div>
                </form>
