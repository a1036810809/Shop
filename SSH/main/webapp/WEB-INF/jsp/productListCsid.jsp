            ...
            <div class="pagination">
                ...
                <s:if test="csid != null">
                    <s:if test="pageBean.page != 1">
                        ...
                        <a href="product_findByCsid.action?csid=<s:property value="csid" />&page=<s:property value="pageBean.page-1" />"
                    ...
                    %>
                    <a href="product_findByCsid.action?csid=<s:property value="csid" />&page=<%=i%>"><%=i%>
                    </a>
                    <%
                        }
                    %>
