...
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct_update.action"
    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
        ...
        <tr>
            ...
            <td align="center" class="ta_01" bgColor="#ffffff">
                <input type="text" name="market_price" value="<s:property value="model.marketPrice" />" class="bg"/>
            </td>
        </tr>
        <tr>
            <td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
            ...
            <td align="center" class="ta_01" bgColor="#ffffff">
                <input type="text" name="shop_price" value="<s:property value="model.shopPrice" />" class="bg"/>
            </td>
        </tr>
        <tr>
            <td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
